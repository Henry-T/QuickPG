local Test_UILayout_Absolute = class("Test_UILayout_Absolute")

function Test_UILayout_Absolute.Create()
  ...
  for i=1,3 do
    ...
    panel:addChild(img)
    img:setPosition(ccp(40 * i, 40 * i))  -- 此行起不到任何作用
  end
