...
namespace QxGen
{
    ...
    {
        // 载入文本模板
        static string modHead = File.ReadAllText("Templete/ModHead.lua");
        static string modReturn = File.ReadAllText("Templete/ModReturn.lua");
        static string modClassLevel = File.ReadAllText("Templete/ModClassLevel.lua");
        static string modTopLabelDef = File.ReadAllText("Templete/ModTopLabelDef.lua");
        static string modTopImageDef = File.ReadAllText("Templete/ModTopImageDef.lua");
        static string modTopButtonDef = File.ReadAllText("Templete/ModTopButtonDef.lua");
        static string modTopCheckBoxDef = File.ReadAllText("Templete/ModTopCheckBoxDef.lua");
        static string modTopRadioDef = File.ReadAllText("Templete/ModTopRadioDef.lua");
        static string modListDef = File.ReadAllText("Templete/ModListDef.lua");
        static string modRadioFunc = File.ReadAllText("Templete/ModRadioFunc.lua");
        static string modListFunc = File.ReadAllText("Templete/ModListFunc.lua");
        static string modSubLabelDef = File.ReadAllText("Templete/ModSubLabelDef.lua");
        static string modSubImageDef = File.ReadAllText("Templete/ModSubImageDef.lua");
        static string modSubButtonDef = File.ReadAllText("Templete/ModSubButtonDef.lua");

        static void Main(string[] args)
        {
            string jsonDir = Path.Combine(Directory.GetCurrentDirectory(), "../../../DemoProj/res/GUIProject");
            string luaDir = Path.Combine(Directory.GetCurrentDirectory(), "../../../DemoProj/scripts/app/gui");
            ...
            DoConvert("PanelA", Path.Combine(jsonDir, "PanelA.json"), Path.Combine(luaDir, "PanelA.lua"));
            DoConvert("PanelB", Path.Combine(jsonDir, "PanelB.json"), Path.Combine(luaDir, "PanelB.lua"));
        }

        public static void DoConvert(string panelName, string inputJsonPath, string outputLuaPath)
        {
            // 预先定义
            string json_className = panelName;
            ...
            // 读取json
            // ==============================
            string jsonStr = File.ReadAllText(inputJsonPath, Encoding.UTF8);
            // 匹配类名
